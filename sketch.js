// AI-Flappy-Bird-Game-Clone
// It's a Voice and Video Controlled Flappy-Bird game
...
function preload() {
  pipeBodySprite = loadImage('data/pipe_marshmallow_fix.png');
  pipePeakSprite = loadImage('data/pipe_marshmallow_fix.png');
  birdSprite = loadImage('data/bird.png');
